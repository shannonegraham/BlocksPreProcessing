function [f, s]               = ProjectSegCoords_plots(f, s,iii,faultname)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
[mx, my]                      = faultobliquemerc_plots([s.lon(:); f.lon1; f.lon2], [s.lat(:); f.lat1; f.lat2], f.lon1', f.lat1', f.lon2', f.lat2',iii,faultname);
